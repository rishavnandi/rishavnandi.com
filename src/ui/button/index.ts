...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      outline:
        'border border-neutral-200 bg-white shadow-sm hover:bg-neutral-100 hover:text-neutral-900 dark:border-neutral-800 dark:bg-black dark:hover:bg-neutral-950 dark:hover:text-neutral-50 dark:hover:border-neutral-700/50',
      secondary:
...
export { Root, type Props, Root as Button, type Props as ButtonProps, buttonVariants };
