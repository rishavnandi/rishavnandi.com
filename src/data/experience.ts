...
export const experienceData: iExperience[] = [
  {
    ...
    aboutRole:
      'Gen AI platform engineer building LLM data pipelines, SLM fine-tuning, agentic assistants, and distributed data services, including Ray workloads that improved processing by up to 30x. Served as a Forward Deployed Engineer on a Palantir-based LLM data pipeline for a major US healthcare company. Separately built GitLab review bots and a LangGraph, Vertex AI, RAG, and MCP assistant, managed Docker and Kubernetes deployments, and adopted uv and Bun to cut CI/CD execution time by up to 50%.',
